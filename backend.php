...
class LeadsLTSAdmin
{
    ...
    public function admin_init()
    {
        ...
        register_setting('leads_lts_settings', 'leads_lts_enabled_pages'); // Nueva configuración
    }
            ...
            <div class="leads-lts-admin-grid">
                <div class="leads-lts-column-left">
                        ...
                        <form method="post" action="options.php">
                            ...
                            <table class="form-table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="leads_lts_default_camphone"
                                            value="<?php echo esc_attr($default_camphone); ?>" class="regular-text"
                                            placeholder="Ej: 5597186629" />
                                        <p class="description">Este será el número asignado cuando no se encuentre mapeo
                                            específico.</p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="leads_lts_phone_selector"
                                            value="<?php echo esc_attr($phone_selector); ?>" class="regular-text"
                                            placeholder="Ej: #call" />
                                        <p class="description">Selector CSS del elemento que contiene el teléfono (por defecto:
                                            <code>#call</code>). Ejemplos: <code>#call</code>, <code>.phone</code>,
                                            <code>#telefono</code>
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="description">Guarda un registro detallado de todas las llamadas a la API LTS
                                            en <code>log.txt</code>.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">Páginas con Redirección CF7</th>
                                    <td>
                                        <?php
                                        ...
                                        $pages = get_pages();
                                        ?>
                                        <select name="leads_lts_enabled_pages[]" multiple size="10"
                                            style="width: 100%; max-width: 400px;">
                                            <?php foreach ($pages as $page): ?>
                                                <option value="<?php echo esc_attr($page->ID); ?>" <?php echo in_array($page->ID, $enabled_pages) ? 'selected' : ''; ?>>
                                                    ID: <?php echo $page->ID; ?> - <?php echo esc_html($page->post_title); ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                        <p class="description">Selecciona las páginas donde quieres que se active la redirección
                                            de Contact Form 7 a /gracias/. Mantén presionada la tecla Ctrl (Cmd en Mac) para
                                            seleccionar múltiples páginas.</p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="card">
                        <h2>Cómo usar</h2>
                        <ol>
                            <li><strong>CamPhone Default:</strong> Se usa cuando no se encuentra un mapeo específico para un
                                número.</li>
                            <li><strong>Selector de Teléfono:</strong> Elemento HTML del cual se obtiene el número de teléfono.
                            </li>
                            <li><strong>Mapeo de Teléfonos:</strong> Permite asignar números específicos a CamPhones
                                particulares.</li>
                            <li><strong>Formato:</strong> El teléfono original puede incluir o no el prefijo 'tel:' (ej:
                                'tel:8008800810' o '8008800810').</li>
                            <li><strong>Prioridad:</strong> Si existe un mapeo específico, se usa ese. Si no, se usa el CamPhone
                                default.</li>
                        ...
                        <div class="add-mapping-form">
                            ...
                            <table class="form-table">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="original_phone" class="regular-text"
                                            placeholder="Ej: 8008800810" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="mapped_camphone" class="regular-text"
                                            placeholder="Ej: 5597186629" />
                                ...
                                <tr>
                                    <th scope="row"></th>
                                    <td>
                                        <button type="button" id="add-mapping" class="button button-primary">Añadir
                                            Mapeo</button>
                                    </td>
                                </tr>
                            </table>
                                    ...
                                    <tbody id="mappings-table-body">
                                        <?php foreach ($phone_mappings as $original => $camphone): ?>
                                            <tr data-original="<?php echo esc_attr($original); ?>">
                                                ...
                                                <td>
                                                    <button type="button" class="button delete-mapping"
